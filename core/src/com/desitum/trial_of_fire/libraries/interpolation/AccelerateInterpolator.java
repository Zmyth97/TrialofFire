...
public class AccelerateInterpolator implements Interpolator {
    ...
    /**
     * Gets a new {@link com.desitum.trial_of_fire.libraries.interpolation.AccelerateInterpolator} from a maintained pool of {@link Interpolator}s.
     *
     * @param factor the factor controlling the rate of change
     * @return the obtained {@link com.desitum.trial_of_fire.libraries.interpolation.AccelerateInterpolator}
     */
     ...
     * Gets a new {@link com.desitum.trial_of_fire.libraries.interpolation.AccelerateInterpolator} from a maintained pool of {@link Interpolator}s.
     * <p/>
     * The initial factor is set to <code>{@value com.desitum.trial_of_fire.libraries.interpolation.AccelerateInterpolator#DEFAULT_FACTOR}</code>.
     *
     * @return the obtained {@link com.desitum.trial_of_fire.libraries.interpolation.AccelerateInterpolator}
     */
