package com.desitum.trial_of_fire.libraries.interpolation;
/*******************************************************************************
...
public interface Interpolator {
     ...
     *              represents the end
     * @return The interpolation value. This value can be more than 1.0 for {@link com.desitum.trial_of_fire.libraries.interpolation.Interpolator}s which overshoot their targets, or
     * less than 0 for {@link com.desitum.trial_of_fire.libraries.interpolation.Interpolator}s that undershoot their targets.
     */
    float getInterpolation(float input);

    /**
     * Called when the animation has finished and the {@link com.desitum.trial_of_fire.libraries.interpolation.Interpolator} is no longer needed.
     */
    void finished();
