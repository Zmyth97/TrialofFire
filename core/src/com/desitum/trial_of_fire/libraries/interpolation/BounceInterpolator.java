...
public class BounceInterpolator implements Interpolator {
    ...
    /**
     * Gets a new {@link com.desitum.trial_of_fire.libraries.interpolation.BounceInterpolator} from a maintained pool of {@link Interpolator}s.
     *
     * @param factor the factor controlling the rate of overshoot energy change
     * @return the obtained {@link com.desitum.trial_of_fire.libraries.interpolation.BounceInterpolator}
     */
     ...
     * Gets a new {@link com.desitum.trial_of_fire.libraries.interpolation.BounceInterpolator} from a maintained pool of {@link Interpolator}s.
     * <p/>
     * The initial factor is set to <code>{@value com.desitum.trial_of_fire.libraries.interpolation.BounceInterpolator#DEFAULT_FACTOR}</code>.
     *
     * @return the obtained {@link com.desitum.trial_of_fire.libraries.interpolation.BounceInterpolator}
     */
