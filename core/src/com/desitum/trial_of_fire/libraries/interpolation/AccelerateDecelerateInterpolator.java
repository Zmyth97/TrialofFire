...
public class AccelerateDecelerateInterpolator implements Interpolator {
    ...
    /**
     * Gets a new {@link com.desitum.trial_of_fire.libraries.interpolation.AccelerateDecelerateInterpolator} from a maintained pool of {@link Interpolator}s.
     *
     * @param factor the factor controlling the rate of speed change
     * @return the obtained {@link com.desitum.trial_of_fire.libraries.interpolation.AccelerateDecelerateInterpolator}
     */
     ...
     * Gets a new {@link com.desitum.trial_of_fire.libraries.interpolation.AccelerateDecelerateInterpolator} from a maintained pool of {@link Interpolator}s.
     * <p/>
     * The initial factor is set to <code>{@value com.desitum.trial_of_fire.libraries.interpolation.AccelerateDecelerateInterpolator#DEFAULT_FACTOR}</code>.
     *
     * @return the obtained {@link com.desitum.trial_of_fire.libraries.interpolation.AccelerateDecelerateInterpolator}
     */
