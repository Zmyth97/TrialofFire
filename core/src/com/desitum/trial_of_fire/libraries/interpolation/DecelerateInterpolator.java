...
public class DecelerateInterpolator implements Interpolator {
    ...
    /**
     * Gets a new {@link com.desitum.trial_of_fire.libraries.interpolation.DecelerateInterpolator} from a maintained pool of {@link Interpolator}s.
     *
     * @param factor the factor controlling the rate of change
     * @return the obtained {@link com.desitum.trial_of_fire.libraries.interpolation.DecelerateInterpolator}
     */
     ...
     * Gets a new {@link com.desitum.trial_of_fire.libraries.interpolation.DecelerateInterpolator} from a maintained pool of {@link Interpolator}s.
     * <p/>
     * The initial factor is set to <code>{@value com.desitum.trial_of_fire.libraries.interpolation.DecelerateInterpolator#DEFAULT_FACTOR}</code>.
     *
     * @return the obtained {@link com.desitum.trial_of_fire.libraries.interpolation.DecelerateInterpolator}
     */
